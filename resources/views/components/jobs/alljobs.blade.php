<div class="container">
    <div class="alljobs-title-wrapper text-center py-4">
        <h3 class="text-4xl text-green-500 font-semibold">Your job search starts here</h3>
    </div>
    <div class="recentjob-wrapper py-10">
        <h3 class="text-3xl font-bold text-center pb-12">All Published Jobs</h3>
        ...
        <div class="bg-zinc-200 p-3 h-[500px] overflow-y-scroll" id="eachJob"></div>
            ...
            const titleData = res.data.map(item => {
                ...
                return ` <div class="flex justify-between items-center bg-blue-200 p-5 rounded-xl mb-3"> 
                        ...
                        <div class="rightPart">
                            ...
                            <button 
                                class="text-base text-white font-medium bg-blue-600 px-3 py-1 rounded-lg hover:bg-blue-900 applyJobBtn" data-applyjobid="${item.id}">APPLY</button>
                        </div>
                </div>`
            }).join('');
            ...
            applyBtn.forEach(button => {
                button.addEventListener('click', async () => {
                    ...
                    if (!t) {
                        ...
                        let jobId = button.getAttribute('data-applyjobid');
