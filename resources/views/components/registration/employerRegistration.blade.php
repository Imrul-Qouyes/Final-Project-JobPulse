<div class="relative p-4 w-full max-w-md max-h-full mx-auto">
        ...
        <div class="p-4 md:p-5">
            <form class="space-y-4" action="#">
              @csrf
                ...
                <button onclick="registerEmployer(event)"
                ...
                <div class="text-sm font-medium text-center text-gray-500 dark:text-gray-300">
                    Already Have Account? <a href="{{route('employer.login')}}"
  ...
  <script>
      async function registerEmployer(event) {
          ...
          if (Fname.length === 0) {
              ...
              showLoader();
              let res = await axios.post('/employerSignup', {
                  firstname: Fname,
                  lastname: Lname,
                  email: Email,
                  password: Password,
