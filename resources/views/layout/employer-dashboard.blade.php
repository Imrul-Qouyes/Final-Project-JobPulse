    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ url('/dashboard/employer') }}" class="flex ms-2 md:me-24">
...
<aside id="logo-sidebar"
    class="absolute top-0 left-0 z-30 w-64 h-screen pt-20 transition-transform -translate-x-full bg-green-200 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar">
...
<script>
    ...
    function plugins2(event) {
        event.preventDefault();
        location.href = '/dashboard/employer/plugins'

    }

    document.getElementById('employerEmail').innerText = localStorage.getItem('email');
